Shader "Hidden/MyGPUGShader1"
    {
        Properties
        {
	__UV_z__ ("UV z", Float) = 0.0
...
float __UV_z__;
                ...
                fixed4 frag(v2f IN) : COLOR
				{
                    //------------GPUG/Node stuff------------
                    //--------------------------------------
float NoiseNode0 = 1.0 * PerlinNoise(4.0 * float3(IN.texcoord.x, IN.texcoord.y, __UV_z__), 4.0);


                    //---------------------------------------
                    //---------------------------------------

                    float OUT_expr = NoiseNode0;
return float4(OUT_expr, OUT_expr, OUT_expr, 0);
